...
!function() {
    ...
    var f = "___FONT_AWESOME___", m = function() {
        try {
            return !1;
        } catch (c) {
            return !1;
        }
    }(), h = "classic", t = "sharp", n = [ h, t ];
    function i(c) {
        return new Proxy(c, {
            get: function(c, s) {
    ...
    Object.keys(o[h]).map(s.add.bind(s)), Object.keys(o[t]).map(s.add.bind(s));
    [].concat(n, function(c) {
    ...
    function u(c, s, l) {
        ...
        "function" != typeof v.hooks.addPack || l ? v.styles[c] = e(e({}, v.styles[c] || {}), z) : v.hooks.addPack(c, d(s)), 
        "fas" === c && u("fa", s);
    }
    var g = {
        ...
        "square-full": [ 512, 512, [ 128997, 128998, 128999, 129e3, 129001, 129002, 129003, 11035, 11036 ], "f45c", "M464 48V464H48V48H464zM48 0H0V48 464v48H48 464h48V464 48 0H464 48z" ],
